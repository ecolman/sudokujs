...
import Selectors from './Selectors.container';

const Board = props => {
  const gridClass = props.active ? 'board gridline active' : 'board gridline';
    ...
    <Set>
      ...
      <Set>
        <Path d={'M 230 207 l 0 135 l 30 0 l 0 -135 l -30 0 M 280 207 l 0 135 l 30 0 l 0 -135 z'}
          attr={{ class: 'board pause path' }}
          hide={!props.paused}
          update={el => { el.toFront(); } }></Path>
        <Rect
          x={230} y={207}
          height={135} width={80}
          attr={{ class: 'board pause container' }}
