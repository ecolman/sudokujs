          ...
          switch (e.data.result) {
            case sudokuUniqueResult.unique:
              ...
              if (successCount > 1) {
                ...
                sudoku.workerResults[e.data.threadNum] = {
                  'result': sudokuUniqueResult.notUnique, 'board': sudoku.workerResults[e.data.threadNum].board,
            ...
            case sudokuUniqueResult.noSolution:
              ...
              sudoku.workerResults[e.data.threadNum] = {
                'result': sudokuUniqueResult.noSolution, 'board': sudoku.workerResults[e.data.threadNum].board,
                'successCount': successCount, 'finished': true
              };
